...
const DICT = {
  ...
  "review.title": { mn: "Захиалгаа баталгаажуулах", en: "Confirm your booking" },
  "review.sub": { mn: "Дараах мэдээллээ шалгаад, хүсвэл хоолоо урьдчилан сонгоорой. Дараа нь нэг удаа төлбөрөө хийнэ.", en: "Review the details below. Pre-order food if you like — then pay once at the end." },
  "review.reservation": { mn: "Захиалга", en: "Reservation" },
  "review.preorder": { mn: "Хоол урьдчилан сонгох", en: "Pre-order food" },
  "review.preorderSub": { mn: "Зочлохдоо хүлээх хугацаа багасна. Хүсвэл алгасаад ширээн дээрээ цэснээс сонгож болно.", en: "Skip the wait when you arrive. Optional — you can also order at the table." },
  "review.addFood": { mn: "Цэс үзэх", en: "Browse menu" },
  "review.cartItems": { mn: "Урьдчилан сонгосон хоол", en: "Pre-ordered dishes" },
  "review.editCart": { mn: "Засах", en: "Edit" },
  "review.deposit": { mn: "Урьдчилгаа", en: "Deposit" },
  "review.foodTotal": { mn: "Хоолны дүн", en: "Food total" },
  "review.totalToPay": { mn: "Нийт төлөх дүн", en: "Total to pay" },
  "review.payAndConfirm": { mn: "Төлөөд баталгаажуулах", en: "Pay & confirm" },
